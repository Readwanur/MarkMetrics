...
<head>
    ...
    <meta name="description"
        content="Manage your grades, submit correction requests, and withdraw from courses on the MarkMetrics Student Portal.">
    <link
        href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&family=Outfit:wght@700&display=swap"
        rel="stylesheet">
            ...
            <header class="top-header">
                ...
                <div class="header-main">
                    <div class="header-left">
                        ...
                        <p class="muted">Submit grade correction requests and manage course withdrawals. All changes are
                            logged for audit.</p>
                    </div>
            ...
            <div class="content-grid">
                <div class="form-container">
                    ...
                    <div class="tab-panel active" id="panel-correction">
                        <div class="card form-card">
                            ...
                            <div class="card-title">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#FF8A00"
                                    stroke-width="2">
                            ...
                            <div class="input-group">
                                ...
                                <textarea id="justification"
                                    placeholder="Detail the specific administrative error or grading correction requirements..."></textarea>
                            </div>
                            ...
                            <div class="draft-notice hidden" id="draft-notice">
                                ...
                                <span>Draft restored from your last session. <a href="#"
                                        id="clear-draft">Clear</a></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-panel" id="panel-withdrawal">
                        <div class="card form-card">
                            <div class="card-title">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fa5252"
                                    stroke-width="2">
                                    <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path>
                                    <polyline points="16 17 21 12 16 7"></polyline>
                                    <line x1="21" y1="12" x2="9" y2="12"></line>
                            ...
                            <div class="withdrawal-warning">
                                ...
                                <div>
                                    ...
                                    <p>Withdrawing from a course will assign a grade of <strong>"W"</strong> on your
                                        transcript. This action is permanent and cannot be undone. Only
                                        <strong>ongoing</strong> courses are eligible for withdrawal.</p>
                                </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <textarea id="withdrawal-reason"
                                    placeholder="Provide a reason for withdrawing from this course..."
                                    rows="3"></textarea>
                            </div>
                    ...
                    <div class="card protocol-card">
                        <div class="card-title">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#FF8A00"
                                ...
                                <path
                                    d="M12 2a7 7 0 0 1 7 7c0 2.38-1.235 4.474-3.1 5.7L15 17H9l-.9-2.3C6.235 13.474 5 11.38 5 9a7 7 0 0 1 7-7z">
                                </path>
                            </svg>
                            <span>Quick Tip</span>
                        </div>
                        <p>Ensure all grade correction requests include a clear justification. Requests without proper
                            reasoning are typically rejected within 48 hours by the registrar's office.</p>
                    </div>
                </div>
            </div>
        </main>
