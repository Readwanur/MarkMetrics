                ...
                <div class="secondary-col">
                    <div class="side-card progress-card">
                        <div class="card-header">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#4dabf7"
                                stroke-width="2">
                    ...
                    <div class="side-card insight-card">
                        <svg class="bg-star" width="100" height="100" viewBox="0 0 24 24" fill="#1e1e1e"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                        </svg>
                        <span class="mini-label orange-text">MARKMETRICS INSIGHT</span>
                        <p>Maintaining your current <strong>4.0 GPA</strong> for the final semester will graduate you
                            with <strong>Magna Cum Laude</strong> honors.</p>
                        <a href="#" class="pathway-link">VIEW GRADUATION PATHWAY <svg width="14" height="14"
